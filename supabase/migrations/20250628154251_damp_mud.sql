/*
  ...
  1. Database Functions
    - `increment_free_events_used` - Safely increment free events used counter
...
DROP FUNCTION IF EXISTS increment_free_events_used(UUID);
DROP FUNCTION IF EXISTS deduct_user_credits(UUID, NUMERIC);
